...
namespace GGUFMeta {
    ...
    template bool llama_model_loader::get_arr<int, 5>(const std::string & key, std::array<int, 5> & result, bool required);
    template bool llama_model_loader::get_arr<std::array<int, 5>>(enum llm_kv kid, std::array<int, 5> & result, bool required);
